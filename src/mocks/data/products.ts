...
export function getProducts(tierId: number): Product[] {
  return [
    ...
    makeProduct(1, 'PL001-BLK', 'Muffler Extension Pipe - Black', 'ProLine', 19.00, 'A1-1', 'Pack Qty', 11, 'Exhaust',
      ...
      [
        { sku: 'PL001-BLK-01', value: '1', packQty: 1, priceAdj: 0, map: 39.99, upc: '012345678901', available: 25, incoming: 0 },
        { sku: 'PL001-BLK-06', value: '6', packQty: 6, priceAdj: -1.50, map: 239.94, upc: '012345678902', available: 4, incoming: 12 },
      ], tierId),
    ...
    makeProduct(2, 'PL001-CHR', 'Muffler Extension Pipe - Chrome', 'ProLine', 22.00, 'A1-2', 'Pack Qty', 11, 'Exhaust',
      ...
      [
        { sku: 'PL001-CHR-01', value: '1', packQty: 1, priceAdj: 0, map: 44.99, upc: '012345678911', available: 0, incoming: 30 },
        { sku: 'PL001-CHR-06', value: '6', packQty: 6, priceAdj: -2.00, map: 269.94, upc: '012345678912', available: 2, incoming: 0 },
      ], tierId),
    ...
    makeProduct(3, 'EX100', 'Performance Exhaust Tip', 'TurboKing', 14.50, 'A2-1', 'Pack Qty', 11, 'Exhaust',
      ...
      [
        { sku: 'EX100-01', value: '1', packQty: 1, priceAdj: 0, map: 29.99, upc: '023456789001', available: 18, incoming: 0 },
        { sku: 'EX100-02', value: '2', packQty: 2, priceAdj: -0.50, map: 59.98, upc: '023456789002', available: 7, incoming: 20 },
        { sku: 'EX100-12', value: '12', packQty: 12, priceAdj: -2.00, map: 359.88, upc: '023456789003', available: 1, incoming: 0 },
      ], tierId),
    ...
    makeProduct(4, 'LT200-WHT', 'LED Work Light Bar - White', 'LumenPro', 34.00, 'B3-1', 'Pack Qty', 12, 'Lighting',
      ...
      [
        { sku: 'LT200-WHT-01', value: '1', packQty: 1, priceAdj: 0, map: 69.99, upc: '034567890001', available: 15, incoming: 0 },
        { sku: 'LT200-WHT-04', value: '4', packQty: 4, priceAdj: -2.00, map: 279.96, upc: '034567890002', available: 3, incoming: 8 },
      ], tierId),
    ...
    makeProduct(5, 'LT201-AMB', 'LED Light Bar - Amber', 'LumenPro', 32.00, 'B3-2', 'Pack Qty', 12, 'Lighting',
      ...
      [
        { sku: 'LT201-AMB-01', value: '1', packQty: 1, priceAdj: 0, map: 64.99, upc: '034567890011', available: 0, incoming: 0 },
      ], tierId),
    ...
    makeProduct(6, 'JK400-BLK', 'Motorcycle Leather Jacket - Black', 'RiderEdge', 89.00, 'C1-1', 'Size', 21, 'Jackets',
      ...
      [
        { sku: 'JK400-BLK-S', value: 'S', packQty: 1, priceAdj: 0, map: 179.99, upc: '045678900001', available: 12, incoming: 0 },
        { sku: 'JK400-BLK-M', value: 'M', packQty: 1, priceAdj: 0, map: 179.99, upc: '045678900002', available: 8, incoming: 20 },
        { sku: 'JK400-BLK-L', value: 'L', packQty: 1, priceAdj: 0, map: 179.99, upc: '045678900003', available: 3, incoming: 0 },
    ...
    makeProduct(7, 'JK400-BRN', 'Motorcycle Leather Jacket - Brown', 'RiderEdge', 92.00, 'C1-2', 'Size', 21, 'Jackets',
      ...
      [
        { sku: 'JK400-BRN-M', value: 'M', packQty: 1, priceAdj: 0, map: 184.99, upc: '045678900011', available: 7, incoming: 0 },
        { sku: 'JK400-BRN-L', value: 'L', packQty: 1, priceAdj: 0, map: 184.99, upc: '045678900012', available: 5, incoming: 0 },
    ...
    makeProduct(8, 'GL100-BLK', 'Riding Gloves - Black', 'RiderEdge', 18.00, 'C2-1', 'Size', 22, 'Gloves',
      ...
      [
        { sku: 'GL100-BLK-S', value: 'S', packQty: 1, priceAdj: 0, map: 36.99, upc: '056789000001', available: 22, incoming: 0 },
        { sku: 'GL100-BLK-M', value: 'M', packQty: 1, priceAdj: 0, map: 36.99, upc: '056789000002', available: 14, incoming: 0 },
        { sku: 'GL100-BLK-L', value: 'L', packQty: 1, priceAdj: 0, map: 36.99, upc: '056789000003', available: 6, incoming: 10 },
    ...
    makeProduct(9, 'GL100-BRN', 'Riding Gloves - Brown', 'RiderEdge', 18.00, 'C2-2', 'Size', 22, 'Gloves',
      ...
      [
        { sku: 'GL100-BRN-M', value: 'M', packQty: 1, priceAdj: 0, map: 36.99, upc: '056789000011', available: 11, incoming: 0 },
        { sku: 'GL100-BRN-L', value: 'L', packQty: 1, priceAdj: 0, map: 36.99, upc: '056789000012', available: 4, incoming: 12 },
      ], tierId),
    ...
    makeProduct(10, 'TL500', 'Socket Wrench Set', 'GripMaster', 28.00, 'D1-1', 'Pack Qty', 31, 'Hand Tools',
      ...
      [
        { sku: 'TL500-01', value: '1', packQty: 1, priceAdj: 0, map: 55.99, upc: '067890100001', available: 9, incoming: 0 },
        { sku: 'TL500-06', value: '6', packQty: 6, priceAdj: -3.00, map: 335.94, upc: '067890100002', available: 2, incoming: 6 },
      ], tierId),
  ];
}
